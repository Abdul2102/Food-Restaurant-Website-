  ...
  const contactInfo = [
    {
      icon: 'MapPin',
      title: 'Address',
      details: ['12 Main Street', 'Foodie District, FD 12345']
    },
    {
      icon: 'Phone',
      title: 'Phone',
      details: ['(555) 123-urban', '(555) 123-7378']
    },
    {
      icon: 'Mail',
      title: 'Email',
      details: ['info@urbanpalaterestaurant.com', 'orders@urbanpalaterestaurant.com']
    },
    {
      icon: 'Clock',
      title: 'Hours',
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-accent">UrbanPalate</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-secondary-foreground/70 font-body text-sm text-center sm:text-left">
              © {currentYear} UrbanPalate Restaurant. All rights reserved. Made with ❤️ for food lovers.
            </p>
