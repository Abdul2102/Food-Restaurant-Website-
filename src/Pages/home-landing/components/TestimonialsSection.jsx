...
const TestimonialsSection = () => {
  ...
  const testimonials = [
  {
    ...
    rating: 5,
    text: "Absolutely incredible! The flavors are authentic and the presentation is beautiful. Urban has become my go-to restaurant for special occasions and casual dining alike.",
    date: "2 days ago"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    rating: 5,
    text: "Outstanding quality and service! I order from urban for all my business meetings. The food always arrives on time and exceeds expectations. Five stars!",
    date: "3 days ago"
  },
  {
    id: 4,
