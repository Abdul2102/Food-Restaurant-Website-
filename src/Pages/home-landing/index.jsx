  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-14 h-14 bg-neon-gradient text-white rounded-full shadow-neon-xl hover:shadow-neon-xl transition-all duration-300 flex items-center justify-center z-40 glass-card animate-pulse-glow"
      >
        <svg
          width="24"
          height="24"
