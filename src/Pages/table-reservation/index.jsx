          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg lg:text-xl font-body opacity-90 max-w-2xl mx-auto">
                Book your perfect dining experience at any of our Urban locations. Choose your preferred restaurant, date, and time for an unforgettable meal.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <div>
                <h3 className="font-heading font-bold text-lg">Urban</h3>
                <p className="text-xs opacity-80 -mt-1">Restaurant</p>
              </div>
            </div>
            <div className="text-center md:text-right">
              <p className="text-sm opacity-80">
                © {new Date()?.getFullYear()} Urban Restaurant. All rights reserved.
              </p>
